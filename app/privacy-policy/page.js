      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Way Forward, 401 Congress Ave. Ste. 3250.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Way Forward, accessible from{" "}
            <a
              href="https://wayforwardcommunity.org/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://wayforwardcommunity.org/
            </a>
          </p>
        </li>
        <li>
